define([
	...
	registerSuite({
		...
		modules: function () {
			...
			assert.deepEqual(
				dojo.require(packageName + '.tests-intern.unit._base.loader.modules.wrapped'),
			...
			assert.strictEqual(require('./modules/factoryArity').module.id, packageName + '/tests-intern/unit/_base/loader/modules/factoryArity');
			...
			assert.strictEqual(require('./modules/factoryArityExports').module.id, packageName + '/tests-intern/unit/_base/loader/modules/factoryArityExports');
			...
			assert.strictEqual(require('./modules/idFactoryArity').module.id, packageName + '/tests-intern/unit/_base/loader/modules/idFactoryArity');
			...
			assert.strictEqual(require('./modules/idFactoryArityExports').module.id, packageName + '/tests-intern/unit/_base/loader/modules/idFactoryArityExports');
