...
dojo.provide('dojo.tests-intern.unit._base.loader.xdomain.local2');
...
dojo.require('dojo.tests-intern.unit._base.loader.xdomain.local3');
xdomainExecSequence.push('local2-4');

dojo['tests-intern'].unit._base.loader.xdomain.local2.status = 'local2-loaded';
